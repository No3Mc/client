    ...
    return (
        <div className='p-5'>
            <div className='pt-5 pb-[30px]'>
                <FormComponent title={form.personalInfo} titleBg={'#71717A'}>
                    <div className='flex flex-col gap-[15px]'>
                        <InputField id='name' title={form.namePlaceholder} placeholder={form.namePlaceholder} language={language} required {...name} />
                        <InputField id='contact' title={form.contactPlaceholder} placeholder={form.contactPlaceholder} language={language} required {...contact} />
                    </div>
                </FormComponent >
            </div>
            ...
            <div className='pt-4 pb-8'>
                <FormComponent title={form.levelsQuestion} titleBg={'#00C73C'}>
                    <div className='flex flex-col gap-[15px]'>
                        <NumberInput id='length' title={form.lengthPlaceholder} language={language} value={length} onChange={(value) => setLength(value)} step={1} required />
                        <NumberInput id='width' title={form.widthPlaceholder} language={language} value={width} onChange={(value) => setWidth(value)} step={1} required />
                    </div>
                </FormComponent >
            </div>
            ...
            <div className='pt-4 pb-8'>
                <FormComponent title={form.totalChickens} titleBg={'#E40000'}>
                    <NumberInput id='noOfChickens' title={form.totalChickens} placeholder={form.chickensPlaceholder} language={language} value={chickens} onChange={(value) => setChickens(value)} step={1} required />
                </FormComponent >
            </div>

            <div className='pt-4 pb-8'>
                <FormComponent title={form.totalChickens} titleBg={'#00C73C'}>
                    <NumberInput id='salaries' title={form.salaries} placeholder={form.salaries} language={language} value={salary} onChange={(value) => setSalary(value)} step={1} required />
                </FormComponent >
            </div>
